...
;----------------------------------------------------------------------------
;
; void KeccakF1600_Pl2_Permute( void *states, unsigned int instanceIndex )
;
    ALIGN
    EXPORT	KeccakF1600_Pl2_Permute
KeccakF1600_Pl2_Permute   PROC
    add		r0, r0, r1, LSL #3			; states += 8 * instanceIndex
    ...
    veor.64 d5, d0,  d1
    veor.64 d5, d5,  d4
KeccakF1600_ParallelPermute_RoundLoop
    ...
    bne                           KeccakF1600_ParallelPermute_RoundLoop
    vstr.64 d12, [r0, #_be]
    vstr.64 d17, [r0, #_bi]
    vstr.64 d22, [r0, #_bo]
    vstr.64 d27, [r0, #_bu]
...
;----------------------------------------------------------------------------
;
; void KeccakF1600_Pl2_PermuteAll( void *states )
;
    ALIGN
    EXPORT	KeccakF1600_Pl2_PermuteAll
KeccakF1600_Pl2_PermuteAll   PROC
