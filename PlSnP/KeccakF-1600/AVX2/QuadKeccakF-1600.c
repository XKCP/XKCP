...
ALIGN const UINT64 KeccakF1600RoundConstants[24] = {
...
void KeccakF1600_Pl4_PermuteAll(void *states)
{
...
void KeccakF1600_Pl4_Permute(void *states, unsigned int instanceIndex)
{
	...
	KeccakF1600_Pl4_PermuteAll( tempStates );
