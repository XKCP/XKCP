...
void KeccakF1600_Pl2_StaticInitialize( void )
{
}
...
void KeccakF1600_Pl2_XORBytes(void *states, unsigned int instanceIndex, const unsigned char *data, unsigned int offset, unsigned int length)
{
...
void KeccakF1600_Pl2_OverwriteBytes(void *states, unsigned int instanceIndex, const unsigned char *data, unsigned int offset, unsigned int length)
{
    unsigned int sizeLeft = length;
    unsigned int lanePosition = offset/SnP_laneLengthInBytes;
    unsigned int offsetInLane = offset%SnP_laneLengthInBytes;
...
void KeccakF1600_Pl2_ExtractBytes(const void *states, unsigned int instanceIndex, unsigned char *data, unsigned int offset, unsigned int length)
{
    unsigned int sizeLeft = length;
    unsigned int lanePosition = offset/SnP_laneLengthInBytes;
    unsigned int offsetInLane = offset%SnP_laneLengthInBytes;
...
void KeccakF1600_Pl2_ExtractAndXORBytes(const void *states, unsigned int instanceIndex,  unsigned char *data, unsigned int offset, unsigned int length)
{
    unsigned int sizeLeft = length;
    unsigned int lanePosition = offset/SnP_laneLengthInBytes;
    unsigned int offsetInLane = offset%SnP_laneLengthInBytes;
...
{
    const UINT64 *stateAsLanes = states;
    unsigned int i;
    UINT64 *curData0 = (UINT64 *)data;
    UINT64 *curData1 = (UINT64 *)(data+laneOffset*SnP_laneLengthInBytes);

	#define	ExtrXOR( argIndex )	curData0[argIndex] ^= stateAsLanes[2*(argIndex)], curData1[argIndex] ^= stateAsLanes[2*(argIndex)+1]

	#if defined(UseSSE2) && 0 // it works but is slower
	#define	ExtrXOR2( argIndex )	lanes0 = XOR128( *(V128*)&stateAsLanes[2*(argIndex)], LOAD6464(curData1[argIndex], curData0[argIndex])), \
									lanes1 = XOR128( *(V128*)&stateAsLanes[2*(argIndex)+2], LOAD6464(curData1[(argIndex)+1], curData0[(argIndex)+1])), \
									STORE128u( *(V128*)&curData0[argIndex], UNPACKL( lanes0, lanes1 ) ),	\
									STORE128u( *(V128*)&curData1[argIndex], UNPACKH( lanes0, lanes1 ) )
	if ( laneCount >= 16 )	{
	    V128 lanes0, lanes1;
		ExtrXOR2( 0 );
		ExtrXOR2( 2 );
...
/*
size_t KeccakF1600_Pl2_FBWL_Absorb(void *states, unsigned int laneCount, unsigned int laneOffsetParallel, unsigned int laneOffsetSerial, unsigned char *data, size_t dataByteLen, unsigned char trailingBits)
{
}

size_t KeccakF1600_Pl2_FBWL_Squeeze(void *states, unsigned int laneCount, unsigned int laneOffsetParallel, unsigned int laneOffsetSerial, unsigned char *data, size_t dataByteLen)
{
}

size_t KeccakF1600_Pl2_FBWL_Wrap(void *states, unsigned int laneCount, unsigned int laneOffsetParallel, unsigned int laneOffsetSerial, const unsigned char *dataIn, unsigned char *dataOut, size_t dataByteLen, unsigned char trailingBits)
{
}

size_t KeccakF1600_Pl2_FBWL_Unwrap(void *states, unsigned int laneCount, unsigned int laneOffsetParallel, unsigned int laneOffsetSerial, const unsigned char *dataIn, unsigned char *dataOut, size_t dataByteLen, unsigned char trailingBits)
{
}
*/
...
void KeccakP1600_12_Pl2_Permute(void *states, unsigned int instanceIndex)
{
	...
	KeccakP1600_12_Pl2_PermuteAll( tempStates );
