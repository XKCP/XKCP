...
KeccakF800_StateInitialize_Loop:
    st      z+, zero
    st      z+, zero
    st      z+, zero
    st      z+, zero
    dec     r23
    brne    KeccakF800_StateInitialize_Loop
...
KeccakF800_StateComplementBit:
    ...
    andi    r20, 7
    breq    KeccakF800_StateComplementBit_LoopEnd
KeccakF800_StateComplementBit_Loop:
    lsl     r21
    dec     r20
    brne    KeccakF800_StateComplementBit_Loop
KeccakF800_StateComplementBit_LoopEnd:
...
KeccakF800_StateXORBytes:
    ...
    movw    rX, r22
    subi    r18, 8
    brcs    KeccakF800_StateXORBytes_Byte
    ;do 8 bytes per iteration
KeccakF800_StateXORBytes_Loop8:
    ld      r21, X+
    ld      r0, Z
    eor     r0, r21
    st      Z+, r0
    ...
    subi    r18, 8
    brcc    KeccakF800_StateXORBytes_Loop8
KeccakF800_StateXORBytes_Byte:
    ldi     r19, 8
    add     r18, r19
    breq    KeccakF800_StateXORBytes_End
KeccakF800_StateXORBytes_Loop1:
    ld      r21, X+
    ld      r0, Z
    eor     r0, r21
    st      Z+, r0
    dec     r18
    brne    KeccakF800_StateXORBytes_Loop1
KeccakF800_StateXORBytes_End:
    ret
...
KeccakF800_StateOverwriteBytes:
    ...
    movw    rX, r22
    subi    r18, 8
    brcs    KeccakF800_StateOverwriteBytes_Byte
    ;do 8 bytes per iteration
KeccakF800_StateOverwriteBytes_Loop8:
    ld      r0, X+
    st      Z+, r0
    ld      r0, X+
    st      Z+, r0
    ...
    st      Z+, r0
    subi    r18, 8
    brcc    KeccakF800_StateOverwriteBytes_Loop8
KeccakF800_StateOverwriteBytes_Byte:
    ldi     r19, 8
    add     r18, r19
    breq    KeccakF800_StateOverwriteBytes_End
KeccakF800_StateOverwriteBytes_Loop1:
    ld      r0, X+
    st      Z+, r0
    dec     r18
    brne    KeccakF800_StateOverwriteBytes_Loop1
KeccakF800_StateOverwriteBytes_End:
    ret
...
KeccakF800_StateOverwriteWithZeroes:
    ...
    lsr     r23
    lsr     r23
    breq    KeccakF800_StateOverwriteWithZeroes_Bytes
KeccakF800_StateOverwriteWithZeroes_LoopLanes:
    ...
    st      Z+, r1
    dec     r23
    brne    KeccakF800_StateOverwriteWithZeroes_LoopLanes
KeccakF800_StateOverwriteWithZeroes_Bytes:
    andi    r22, 3
    breq    KeccakF800_StateOverwriteWithZeroes_End
KeccakF800_StateOverwriteWithZeroes_LoopBytes:
    st      Z+, r1
    dec     r22
    brne    KeccakF800_StateOverwriteWithZeroes_LoopBytes
KeccakF800_StateOverwriteWithZeroes_End:
    ret
...
KeccakF800_StateExtractBytes:
    ...
    movw    rX, r22
    subi    r18, 8
    brcs    KeccakF800_StateExtractBytes_Byte
    ;do 8 bytes per iteration
KeccakF800_StateExtractBytes_Loop8:
    ld      r0, Z+
    st      X+, r0
    ld      r0, Z+
    st      X+, r0
    ...
    st      X+, r0
    subi    r18, 8
    brcc    KeccakF800_StateExtractBytes_Loop8
KeccakF800_StateExtractBytes_Byte:
    ldi     r19, 8
    add     r18, r19
    breq    KeccakF800_StateExtractBytes_End
KeccakF800_StateExtractBytes_Loop1:
    ld      r0, Z+
    st      X+, r0
    dec     r18
    brne    KeccakF800_StateExtractBytes_Loop1
KeccakF800_StateExtractBytes_End:
    ret
...
KeccakF800_StateExtractAndXORBytes:
    ...
    movw    rX, r22
    subi    r18, 8
    brcs    KeccakF800_StateExtractAndXORBytes_Byte
    ;do 8 bytes per iteration
KeccakF800_StateExtractAndXORBytes_Loop8:
    ld      r21, Z+
    ld      r0, X
    eor     r0, r21
    st      X+, r0
    ...
    st      X+, r0
    subi    r18, 8
    brcc    KeccakF800_StateExtractAndXORBytes_Loop8
KeccakF800_StateExtractAndXORBytes_Byte:
    ldi     r19, 8
    add     r18, r19
    breq    KeccakF800_StateExtractAndXORBytes_End
KeccakF800_StateExtractAndXORBytes_Loop1:
    ld      r21, Z+
    ld      r0, X
    eor     r0, r21
    st      X+, r0
    dec     r18
    brne    KeccakF800_StateExtractAndXORBytes_Loop1
KeccakF800_StateExtractAndXORBytes_End:
    ret
...
KeccakP800_12_StatePermute:
    ldi     pRound,   lo8(KeccakP800_12_RoundConstants)
    ldi     pRound+1, hi8(KeccakP800_12_RoundConstants)
    push    r2
    push    r3
    push    r4
    push    r5
...
KeccakTheta_End:
    ...
    push    pRound
    push    pRound+1
    ldi     RPpConst,   lo8(KeccakP800_12_RhoPiConstants)
    ldi     RPpConst+1, hi8(KeccakP800_12_RhoPiConstants)
