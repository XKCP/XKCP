...
KeccakF200_StateXORLanes_Loop32
	ldr		r2, [r1], #4
	ldr		r12, [r0]
	eor		r2, r2, r12
	subs	r3, r3, #4
	str		r2, [r0], #4
	bcs		KeccakF200_StateXORLanes_Loop32
	adds	r2, r3, #4
	beq		KeccakF200_StateXORLanes_Exit
KeccakF200_StateXORLanes_Loop8
	ldrb	r3, [r1], #1
	ldrb	r12, [r0]
	eor		r3, r3, r12
	strb	r3, [r0], #1
	subs	r2, r2, #1
	bne		KeccakF200_StateXORLanes_Loop8
...
KeccakF200_StateXORBytesInLane_Loop
	...
	strb	r1, [r0], #1
	subs	r12, r12, #1
	bne		KeccakF200_StateXORBytesInLane_Loop
...
KeccakF200_StateOverwriteLanes_Loop32
	ldr		r2, [r1], #4
	subs	r3, r3, #4
	str		r2, [r0], #4
	bcs		KeccakF200_StateOverwriteLanes_Loop32
	adds	r2, r3, #4
	beq		KeccakF200_StateOverwriteLanes_Exit
KeccakF200_StateOverwriteLanes_Loop8
	ldrb	r3, [r1], #1
	strb	r3, [r0], #1
	subs	r2, r2, #1
	bne		KeccakF200_StateOverwriteLanes_Loop8
...
KeccakF200_StateOverwriteBytesInLane	PROC
	ldr		r12, [sp]
	cmp		r12, #0
	beq		KeccakF200_StateOverwriteBytesInLane_Exit
	adds	r0, r0, r1
	adds	r0, r0, r3
KeccakF200_StateOverwriteBytesInLane_Loop
	...
	strb	r1, [r0], #1
	subs	r12, r12, #1
	bne		KeccakF200_StateOverwriteBytesInLane_Loop
...
KeccakF200_StateOverwriteWithZeroes_Loop4Lanes
	str		r3, [r0], #4
	subs	r2, r2, #1
	bne		KeccakF200_StateOverwriteWithZeroes_Loop4Lanes
...
KeccakF200_StateExtractLanes_Loop32
	ldr		r2, [r0], #4
	subs	r3, r3, #4
	str		r2, [r1], #4
	bcs		KeccakF200_StateExtractLanes_Loop32
	adds	r2, r3, #4
	beq		KeccakF200_StateExtractLanes_Exit
KeccakF200_StateExtractLanes_Loop8
	ldrb	r3, [r0], #1
	subs	r2, r2, #1
	strb	r3, [r1], #1
	bne		KeccakF200_StateExtractLanes_Loop8
...
KeccakF200_StateExtractBytesInLane_Loop
	...
	subs	r12, r12, #1
	strb	r1, [r2], #1
	bne		KeccakF200_StateExtractBytesInLane_Loop
...
KeccakF200_StateExtractAndXORLanes	PROC
	cbz		r2, KeccakF200_StateExtractAndXORLanes_Exit
	subs	r3, r2, #4
	bcc		KeccakF200_StateExtractAndXORLanes_Loop8
KeccakF200_StateExtractAndXORLanes_Loop32
	ldr		r2, [r0], #4
	ldr		r12, [r1]
	eor		r2, r2, r12
	subs	r3, r3, #4
	str		r2, [r1], #4
	bcs		KeccakF200_StateExtractAndXORLanes_Loop32
	adds	r2, r3, #4
	beq		KeccakF200_StateExtractAndXORLanes_Exit
KeccakF200_StateExtractAndXORLanes_Loop8
	ldrb	r3, [r0], #1
	ldrb	r12, [r1]
	eor		r3, r3, r12
	subs	r2, r2, #1
	strb	r3, [r1], #1
	bne		KeccakF200_StateExtractAndXORLanes_Loop8
...
KeccakF200_StateExtractAndXORBytesInLane	PROC
	ldr		r12, [sp]
	cmp		r12, #0
	beq		KeccakF200_StateExtractAndXORBytesInLane_Exit
	add		r0, r0, r1
	add		r0, r0, r3
KeccakF200_StateExtractAndXORBytesInLane_Loop
	...
	subs	r12, r12, #1
	strb	r1, [r2], #1
	bne		KeccakF200_StateExtractAndXORBytesInLane_Loop
...
;//
	ALIGN
	EXPORT  KeccakF200_StatePermute
...
KeccakF200_StatePermute_RoundLoop
	...
	eor			r8, r8, r1
	cmp			r1, #0x80
	bne			KeccakF200_StatePermute_RoundLoop
	...
	ALIGN
KeccakF200_StatePermute_RoundConstants
	dcb			0x01
	dcb			0x82
	dcb			0x8a
	dcb			0x00
