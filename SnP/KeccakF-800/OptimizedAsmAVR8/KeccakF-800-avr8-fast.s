...
KeccakF800_StatePermute:
    ldi     pRound,   lo8(KeccakF800_RoundConstants)
    ldi     pRound+1, hi8(KeccakF800_RoundConstants)
    push    r2
    push    r3
    push    r4
    push    r5
...
KeccakTheta_End:
    ...
    push    pRound
    push    pRound+1
    ldi     RPpConst,   lo8(KeccakF800_RhoPiConstants)
    ldi     RPpConst+1, hi8(KeccakF800_RhoPiConstants)
