...
#define KeccakP800times8_implementation         "fallback on serial implementation (" KeccakP800_implementation ")"
#define KeccakP800times8_statesSizeInBytes      (((KeccakP800_stateSizeInBytes+(KeccakP800_stateAlignment-1))/KeccakP800_stateAlignment)*KeccakP800_stateAlignment*8)
#define KeccakP800times8_statesAlignment        KeccakP800_stateAlignment
...
void KeccakP800times8_PermuteAll_22rounds(void *states);
