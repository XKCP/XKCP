...
KeccakF400_StatePermute:
    ldi     pRound,   lo8(KeccakF400_RoundConstants)
    ldi     pRound+1, hi8(KeccakF400_RoundConstants)
...
KeccakTheta_End:
    ...
    ld      rTemp0, Y+
    ld      rTemp1, Y+
    ldi     RPpConst,   lo8(KeccakF400_RhoPiConstants)
    ldi     RPpConst+1, hi8(KeccakF400_RhoPiConstants)
